...
const trackerModule = {
  ...
  maxUploadSize: null,
  acceptedMimeTypes: [],
  supportsCoverInSearchResult: false,
  supportsCoverByIdLookup: true,
  supportsMultiCoverPerId: true,
  supportsBatchCoverByIdLookup: false,
  preferredCoverHydrationCount: 1,
  WrapperClass,
  MapperClass,
  SettingsClass,
};
